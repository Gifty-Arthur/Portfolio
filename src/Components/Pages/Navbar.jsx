    ...
    <div className="shadow-md w-full h-[87px] fixed top-0 left-0 bg-black">
      <div className="container">
        <div className="flex items-center flex-wrap gap-14 ">
          ...
          />
          <ul
            className={`ml-2 font-roboto font-medium md:flex md:items-center md:pb-0 pb-12 absolute md:static hidden:  md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
